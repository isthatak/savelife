...
INSERT INTO `adpassword` (`id`, `username`, `email_id`, `password`) VALUES
(1, 'grvpandya', 'grvpandya0@gmail.com', 'gaurav');
...
CREATE TABLE IF NOT EXISTS `donorregistration` (
  ...
  `password1` varchar(100) COLLATE armscii8_bin NOT NULL,
  `mobile` varchar(100) COLLATE armscii8_bin NOT NULL,
  `sex` varchar(100) COLLATE armscii8_bin NOT NULL,
  `street` varchar(100) COLLATE armscii8_bin NOT NULL,
  ...
  `donortype` varchar(100) COLLATE armscii8_bin NOT NULL,
  `certificate` varchar(100) COLLATE armscii8_bin NOT NULL,
  `when1` varchar(100) COLLATE armscii8_bin NOT NULL,
  `lastdonate` varchar(50) COLLATE armscii8_bin NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `donorregistration` (`id`, `name`, `lastname`, `email`, `password1`, `mobile`, `sex`, `street`, `area`, `city`, `state`, `pincode`, `country`, `bloodgroup`, `donortype`, `certificate`, `when1`, `lastdonate`) VALUES
(3, 'neha', 'katariya', 'katarianeha.21@gmail.com', 'neha', '78888888888', 'MALE', 'street', 'area', 'Banswara', 'Rajasthan', '328809', 'india', 'B-', 'Help', 'logo.png', 'thrusday', '2014/01/2'),
(4, 'gaurav', 'pandya', 'grvpandya@yahoo.com', 'ganesha', '9828647609', 'MALE', 'mohan colony road2', 'post chidiyawasa', 'Banswara', 'Rajasthan', '327001', 'india', 'B+', 'Eye', 'gauravnew.doc', 'sunday', '2014/01/2'),
(5, 'vikas', ' pandey', 'vikaspandey@gmail.com', 'vikas', '100', 'MALE', 'ashok nagar', 'ashok nagar', 'Banswara', 'Rajasthan', '327001', 'india', 'O-', 'Blood', 'gauravnew.doc', 'sunday', '2014/01/2'),
(6, 'gaurav', 'pandya', 'grvpandya@hotmail.com', '123', '9829212887', 'MALE', 'ashok nagr', 'rod no5', 'Udaipur', 'Rajasthan', '3222', 'india', 'B+', 'Blood', '', 'tuesday', '2014/01/2');
...
CREATE TABLE IF NOT EXISTS `news` (
  `id` int(11) NOT NULL,
  `heading` varchar(255) COLLATE armscii8_bin NOT NULL,
...
INSERT INTO `news` (`id`, `heading`, `description`, `date`) VALUES
(2, 'gdj', ' saves innumerable lives across the world in a variety of conditions. The need for blood is great - on any given day, approximately 39,000 units of Red Blood Cells are needed. More than 29 million units of blood components are transfused every year. ', '0000-00-00'),
(2, 'gdj', ' saves innumerable lives across the world in a variety of conditions. The need for blood is great - on any given day, approximately 39,000 units of Red Blood Cells are needed. More than 29 million units of blood components are transfused every year. ', '0000-00-00'),
(3, '', '', '0000-00-00'),
(4, 'kjgads', 'hgadkj', '0000-00-00');
...
CREATE TABLE IF NOT EXISTS `request` (
  ...
  `d_id` varchar(255) COLLATE armscii8_bin NOT NULL,
  `hospital` varchar(255) COLLATE armscii8_bin NOT NULL,
  `region` varchar(255) COLLATE armscii8_bin NOT NULL,
  `status` varchar(255) COLLATE armscii8_bin NOT NULL,
  `type` varchar(255) COLLATE armscii8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin AUTO_INCREMENT=8 ;

--
-- Dumping data for table `request`
--

INSERT INTO `request` (`id`, `u_id`, `d_id`, `hospital`, `region`, `status`, `type`) VALUES
(1, '', '4', 'american hospital', 'bavasir', 'UNSEEN', 'Blood'),
(2, '', '4', 'ad', 'ad', 'UNSEEN', 'Blood'),
(3, '', '4', 'dada', 'asdfa', 'UNSEEN', 'Blood'),
(4, '4', '4', 'ggg', 'hhh', 'SEEN', 'Blood'),
(5, '4', '4', 'ad', 's', 'SEEN', 'Blood'),
(6, '', '3', '', '', '0', 'Eye'),
(7, '4', '6', 'american hospital', 'ad', 'UNSEEN', 'Blood');
...
CREATE TABLE IF NOT EXISTS `userregistration` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE armscii8_bin NOT NULL,
  `lname` varchar(100) COLLATE armscii8_bin NOT NULL,
  `email` varchar(100) COLLATE armscii8_bin NOT NULL,
  `password2` varchar(100) COLLATE armscii8_bin NOT NULL,
  `mobile` varchar(100) COLLATE armscii8_bin NOT NULL,
  `sex` varchar(100) COLLATE armscii8_bin NOT NULL,
  `street` varchar(100) COLLATE armscii8_bin NOT NULL,
  `area` varchar(100) COLLATE armscii8_bin NOT NULL,
...
INSERT INTO `userregistration` (`id`, `name`, `lname`, `email`, `password2`, `mobile`, `sex`, `street`, `area`, `city`, `state`, `pincode`, `country`, `bloodgroup`) VALUES
(4, 'gaurav', 'pandya', 'grvpandya0@yahoo.com', 'ganesha', '9828647609', 'MALE', 'mohan colony road2', 'post chidiyawasa', 'Banswara', 'Rajasthan', '327001', 'india', 'B+');
