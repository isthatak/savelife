...
<div class="shell">
  <div class="border">
    ...
    <div id='menu'>
  	<ul class="menu">
        ...
        <li ><a href="profileupdate.php" class="parent"><span>Profile update here</span></a></li>
          ...
          <li ><a href="viewdonors.php" class="parent"><span>View donors</span></a></li>
    ...
    <div id="main">
      ...
      <p class="w1">Post your help requirement</p>
       <p class="userpannel"><?php echo $_SESSION['uname']; ?></p><br />
     <p class="userpannel"><?php echo $_SESSION['user']; ?></p>
     <p class="userpannel">&nbsp;</p>
  
    <form name="rpost" method="POST" action="postinserthelp.php">
      <div class="con" id="con">
        ...
        <div class="searchcontent">
          ...
          <div class="searchs">
                    <p><strong>
                      ...
                      <input name="region" style="height:30px; width:200px;box-shadow: 4px 4px 5px #888888;" required autofocus="autofocus"/> &nbsp;</p>
                    <p>&nbsp;</p>
          </div>
        ...
        <div class="searchcontent">
          <div class="searchf">
          <strong>
          <o1>Details</o1></strong><br />
          <input type="text" name="details" style="height:30px; width:200px;box-shadow: 4px 4px 5px #888888;" required autofocus="autofocus" />
        ...
        <input type="submit" name="p" value="Post here" style="margin-left:400px">
      </div>
      </form>
