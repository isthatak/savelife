 ...
 $conn=mysqli_connect('localhost','root','','savelife');
  ...
  $country=$_POST['country'];
    $state=$_POST['state'];
	  ...
	  $q=mysqli_query($conn,"select country,state,city,bloodgroup,name,id from donorregistration where country='$country' and state='$state' and city='$city' and donortype='Help'");
	while($row=mysqli_fetch_array($q))
	{
        ...
        echo"<tbody><tr bgcolor='#fffff'>";
		  ...
		  echo"<td ><div align='center'><a href ='rhelp.php?id=$id'><center><sd>Send request</sd></center></a>";
