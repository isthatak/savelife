 ...
 $conn=mysqli_connect('localhost','root','','savelife');
  ...
  $country=$_POST['country'];
    $state=$_POST['state'];
	  ...
	  $q=mysqli_query($conn,"select country,state,city,bloodgroup,name,id from donorregistration where country='$country' and state='$state' and city='$city' and bloodgroup='$bjp' and donortype='Eye'");
	while($row=mysqli_fetch_array($q))
	{
        ...
        echo"<tbody><tr bgcolor='#fffff'>";
          ...
          echo"<td width='80'><div align='center'><strong><sd>".$bg."</sd> </strong></div></td>";
		  echo"<td ><div align='center'><a href ='reye.php?id=$id'><center><sd>Send request</sd></center></a>";
