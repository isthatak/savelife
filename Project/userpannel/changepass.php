  ...
  <div class="border">
    ...
    <div id="main">
     ...
     <p class="userpannel"><?php echo $_SESSION['user']; ?></p>
       ...
       <input type="text" name="oldpass" style="height:30px; width:200px;box-shadow: 4px 4px 5px #888888; margin-left:30px; margin-right:30px;" required autofocus="autofocus" />
         <label class="sidebar-nav"> New Password :</label>
        <input type="text" name="newpass" style="height:30px; width:200px;box-shadow: 4px 4px 5px #888888; margin-left:30px" required autofocus="autofocus" />
        <center>
       <input type="submit" name="pb" value="Change !"  style="height:30px; width:200px;box-shadow: 4px 4px 5px #888888; margin-top:50px" />
