...
{
var x=document.forms["f3"]["oldpass"].value;
var y=document.forms["f3"]["newpass"].value;
if (x==null || x==""||y==null || y=="")
  {
  alert("First please enter both password");
  return false;
  }
}
  ...
  <div class="border">
    ...
    <div id='menu'>
  	<ul class="menu">
        ...
        <li ><a href="index.php" class="parent"><span>Profile update here</span></a></li>
    ...
    <div id="main">
     ...
     <p class="userpannel"><?php echo $_SESSION['user']; ?></p>
       ...
       <form action="changepassscript.php" method="post" name="f3">
         <label class="sidebar-nav"> Old Password:</label>
       <input type="text" name="oldpass" style="height:30px; width:200px;box-shadow: 4px 4px 5px #888888; margin-left:30px; margin-right:30px;" />
         <label class="sidebar-nav"> New Password :</label>
        <input type="text" name="newpass" style="height:30px; width:200px;box-shadow: 4px 4px 5px #888888; margin-left:30px" /><br/><br/>please enter your privious password
        <center>
          <p>
            <input type="submit" name="pb" value="Change !" onclick="return validateForm()" style="height:30px; width:200px;box-shadow: 4px 4px 5px #888888; margin-top:50px" />
