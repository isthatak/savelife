...
<div class="shell">
  <div class="border">
    ...
    <div id="main">
      ...
      <p class="w1">Post your blood requirement</p>
       <p class="userpannel"><?php echo $_SESSION['uname']; ?></p><br />
     <p class="userpannel"><?php echo $_SESSION['user']; ?></p><p>&nbsp;</p>
  
    <form name="rpost" method="POST" action="postinsertblood.php">
      <div class="con" id="con">
        ...
        <div class="searchcontent">
          ...
          <div class="searchs">
                    <strong><o1>Blood group</o1></strong>
                    <br />
                     <?php echo $blood;?>
          </div>
   ...
   <input name="hospital" style="height:30px; width:200px;box-shadow: 4px 4px 5px #888888;" required autofocus="autofocus"/>
          ...
          <div class="searchs">
                    <strong><o1> for requirement</o1></strong><br />
    <input name="region" style="height:30px; width:200px;box-shadow: 4px 4px 5px #888888" required autofocus="autofocus"/>

          
          
          </div>
          <p>&nbsp;</p>
          <input type="submit" name="p" value="Post here" style="margin-left:400px; margin-top:60px" />
        </div>
      </div>
      </form>
