...
<div class="shell">
  ...
  $country=$_POST['country'];
    $state=$_POST['state'];
	  ...
	  $q=mysqli_query($conn,"select country,state,city,bloodgroup,name,id from donorregistration where country='$country' and state='$state' and city='$city' and bloodgroup='$bjp' and donortype='Blood'");
	  $s1="select country,state,city,bloodgroup,name,id from donorregistration where country='$country' and state='$state' and city='$city' and bloodgroup='$bjp' and donortype='Blood'";
	  //echo s1;
