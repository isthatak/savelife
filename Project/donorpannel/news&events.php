        ...
        <div class="sidebar-nav">
          <ul>
           ...
           <h2><?php echo $n;?></h2> 
              ...
              <li> » Please Found news all .<br />
                » donor can find hospital and camp where he can easily donate his blood » if donor want to donate blood eye or help then accept user request and can intract with user and donate to user.<br>
                » THANKS FOR BEING HUMAN</li>
            </ul>
