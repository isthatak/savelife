...
$c=0;
$p=mysqli_query($conn,"select * from request where u_id='$w' and status='UNSEEN' and type='Eye'");
          ...
          echo"<td width='120'><div align='center' ><strong>".$city1."</strong></div></td>";
		   ...
		   echo"<td width='140'><div align='center'><strong>".$hos."</strong></div></td>";
		     echo"<td width='80'><div align='center'><strong>".$reg."</strong></div></td>";
			  ...
			  echo"<td align='center'width='80'><div ><a href ='accepte.php?d_id=$reqid'><center><sd>Accept</sd></center></a>";
...
$c=0;
$p=mysqli_query($conn,"select * from request where u_id='$w' and status='SEEN' and type='Eye'");
while($fd=mysqli_fetch_array($p))
{
